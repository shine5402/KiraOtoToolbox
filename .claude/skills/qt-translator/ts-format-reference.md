# TS file format reference for Qt 6.10

The TS file format used by Qt Linguist is described by the XSD presented below. Be aware that the format may change in future Qt releases.
