...
CVVCPartSplitToolDialogAdapter::CVVCPartSplitToolDialogAdapter(QObject *parent) : ToolDialogAdapter(parent)
{
    setWorkerMetaObj(CVVCPartSplitOtoListModifyWorker::staticMetaObject);
