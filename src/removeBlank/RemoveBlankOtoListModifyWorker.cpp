...
void RemoveBlankOtoListModifyWorker::doWork(const OtoEntryList &srcOtoList, OtoEntryList &resultOtoList,
                                            OtoEntryList &secondSaveOtoList, const OptionContainer &options)
{
    ...
    auto isBlank = [&options](const OtoEntry &oto) -> bool {
        ...
        return oto.alias().isEmpty() && oto.left() == 0.0 && oto.consonant() == 0.0 && rightFlag &&
               oto.preUtterance() == 0.0 && oto.overlap() == 0.0;
    };
