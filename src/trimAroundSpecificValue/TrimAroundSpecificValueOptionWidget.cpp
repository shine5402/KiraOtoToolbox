...
TrimAroundSpecificValueOptionWidget::TrimAroundSpecificValueOptionWidget(QWidget *parent)
    : ToolOptionWidget(parent), ui(new Ui::TrimAroundSpecificValueOptionWidget)
{
    ui->setupUi(this);

    connect(ui->fieldComboBox, &QComboBox::currentTextChanged, this, &ToolOptionWidget::userSettingsChanged);
    connect(ui->targetValueSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged), this,
            &ToolOptionWidget::userSettingsChanged);
    connect(ui->roundingRangeSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged), this,
            &ToolOptionWidget::userSettingsChanged);
}
