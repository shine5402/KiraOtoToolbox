...
QDialog *getOtoDiffDialog(const OtoEntryList &srcOtoList, const OtoEntryList &resultOtoList, int precision,
                          ...
                          QDialogButtonBox::StandardButtons stdButtons = QDialogButtonBox::Ok |
...
bool askUserWithShowOtoList(const OtoEntryList &secondSaveData, const QString &title, const QString &label,
