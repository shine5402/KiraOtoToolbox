...
QVariant OtoListModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation == Qt::Horizontal && role == Qt::DisplayRole) {
        switch (section) {
        case OtoEntry::FILENAME:
            return tr("Filename");
        case OtoEntry::ALIAS:
            return tr("Alias");
        case OtoEntry::LEFT:
            return tr("Left");
        case OtoEntry::CONSONANT:
            return tr("Const field");
        case OtoEntry::RIGHT:
            return tr("Right");
        case OtoEntry::PREUTTERANCE:
            return tr("Preutterance");
        case OtoEntry::OVERLAP:
            return tr("Overlap");
        }
    }
...
QVariant OtoListModel::data(const QModelIndex &index, int role) const
{
    ...
    if (role == Qt::DisplayRole) {
        ...
        case OtoEntry::LEFT:
            return oto.left();
        case OtoEntry::CONSONANT:
            return oto.consonant();
        case OtoEntry::RIGHT:
            return oto.right();
        case OtoEntry::PREUTTERANCE:
            return oto.preUtterance();
        case OtoEntry::OVERLAP:
            return oto.overlap();
        }
    }
