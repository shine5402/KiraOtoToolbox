...
OtoFileSaveWidget::OtoFileSaveWidget(QWidget *parent) : OtoFileSaveWidgetAbstract(parent), ui(new Ui::OtoFileSaveWidget)
{
    ui->setupUi(this);
...
OtoFileSaveWidgetWithSecondFileNameAsDeleted::OtoFileSaveWidgetWithSecondFileNameAsDeleted(QWidget *parent)
    : OtoFileSaveWidgetWithSecondFileName(parent)
{
