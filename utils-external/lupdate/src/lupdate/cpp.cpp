        ...
        case Tok_Ident:
            ...
            if (yyTok == Tok_LeftParen) {
                ...
                case TrFunctionAliasManager::Function_QT_TRID_NOOP:
                    ...
                    break;
                case TrFunctionAliasManager::Function_REGISTER_TOOL:
                    if (tor){
                        prefix = QStringLiteral("TOOL_TYPE::");
                        handleTr(prefix, false);
                    }
                    break;
                case TrFunctionAliasManager::Function_DEFINE_TOOL_NAME:
                    if (tor){
                        prefix = QStringLiteral("TOOL_NAME::");
                        handleTr(prefix, false);
                    }
                    break;
                default:
